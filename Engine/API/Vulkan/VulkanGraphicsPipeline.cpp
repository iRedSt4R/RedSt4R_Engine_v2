...
RedSt4R::API::VulkanGraphicsPipeline::VulkanGraphicsPipeline(RSShader* shader, RS_DESC_GRAPHICSPIPELINE* gpDesc)
{
	...
	viewportState.pViewports = &gpDesc->viewport;
	viewportState.scissorCount = 1;
	viewportState.pScissors = &gpDesc->rect2D;
	...
	if (vkCreatePipelineLayout(gpDesc->device, &pipelineLayoutInfo, nullptr, &m_PipelineLayout) != VK_SUCCESS) {
